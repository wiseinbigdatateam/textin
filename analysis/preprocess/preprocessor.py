...
def remove_words(corpus, words_list):
...
class Preprocessor:
    ...
    def clean(self, documents, options, stop_words):
        # print('clean()')
        # print(documents)
        ...
        for document in documents:
            ...
            if 4 in options:
                document = remove_words(document, stop_words)
